...
import 'package:sss/features/warehouse/presentation/screens/catalog_screen_mobile.dart';
...
class _HomeScreenMobileState extends State<HomeScreenMobile> {
  ...
  Widget build(BuildContext context) {
    ...
    // Mobile uses slightly larger multiplier for legibility
    final logoWidth = size.width * 0.3; // Much larger relative to width for mobile
    final welcomeSize = size.width * 0.08;
    final buttonPaddingH = size.width * 0.12;
    final buttonPaddingV = size.height * 0.02;
    final buttonTextSize = size.width * 0.05;
    final langPaddingH = size.width * 0.06;
    final langPaddingV = size.height * 0.015;
    final langTextSize = size.width * 0.035;
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    GestureDetector(
                      ...
                      child: Container(
                        padding: const EdgeInsets.all(10), // slightly smaller padding on mobile
                        decoration: BoxDecoration(
