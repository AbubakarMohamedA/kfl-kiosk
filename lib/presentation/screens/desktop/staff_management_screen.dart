    ...
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        content: Column(
          mainAxisSize: MainAxisSize.min,
          children: [
            CheckboxListTile(title: const Text('View Orders'), value: true, onChanged: (value) {}),
            CheckboxListTile(title: const Text('Manage Orders'), value: true, onChanged: (value) {}),
            CheckboxListTile(title: const Text('View Inventory'), value: false, onChanged: (value) {}),
            CheckboxListTile(title: const Text('Manage Inventory'), value: false, onChanged: (value) {}),
            CheckboxListTile(title: const Text('View Analytics'), value: false, onChanged: (value) {}),
          ],
        ),
        actions: [
          TextButton(onPressed: () => Navigator.pop(context), child: const Text('Cancel')),
