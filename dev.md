...
> **KFL Kiosk** (package: `sss`) is a cross-platform Flutter self-service kiosk application built for **SSS (KFM)**. It supports ordering, payment, warehouse fulfilment and multi-tenant management, targeting mobile (Android/iOS), tablet, desktop (Linux/macOS/Windows) and web.
